...
import MapWA from "./components/TreeInformaton/MapWA";
...
const TreeInformationWA = () => {
  const scrollY = useRef(new Animated.Value(0)).current;
  const route = useRoute<RouteProp<RootStackParamList, "TreeInformationWA">>();
      ...
      >
        <Animated.View style={[styles.contentWrapper, { transform: [{ translateY: contentTranslateY }] }]}>
          <View style={styles.infoContainer}>
            <Text style={styles.title}>{tree ? tree.tree_name.toUpperCase() : "Loading..."}</Text>
...
export default TreeInformationWA;
