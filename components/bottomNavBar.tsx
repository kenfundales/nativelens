...
import { View, TouchableOpacity, StyleSheet, Keyboard, Modal, Text, Image, Alert } from 'react-native';
            ...
            <View style={styles.modalBody}>
              ...
              {!loading && aiResponse && aiResponse.toUpperCase() !== "UNKNOWN" && treeId && (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    console.log("View button pressed, navigating to TreeInformationWA with treeId:", treeId);
                    setResultModalVisible(false);
                    setImageUri(null);
                    setBase64Image(null);
                    setAiResponse(null);
